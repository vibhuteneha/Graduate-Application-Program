			...
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					<form:form modelAttribute="user">
						<table class="table">
							<tbody>
								<tr>
									...
									<td><form:input type="text" class="form-control input-lg" placeholder="Enter Email-ID"
											path="email" /><font color="red"><i><b><form:errors
														path="email" /></b></i></font></td>
								</tr>
								<tr>
									<th scope="row">Password:</th>
									<td><form:input type="password" class="form-control input-lg" placeholder="Enter Password"
						...
						<center><h4><b><a href = "register.html">New User? Register Here.</a></b></h4></center>
						<br/>
					</form:form>
				</div>
			</div>
